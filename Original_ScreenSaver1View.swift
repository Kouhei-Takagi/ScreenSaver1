//
//  Original_ScreenSaver1View.swift
//  Original-ScreenSaver1
//
//  Created by 高木耕平 on 2022/04/11.
//
...
class DropRainView: NSView {
    init() {
        ...
        wantsLayer = true
        layer?.backgroundColor = CGColor.init(red:0.9, green:0.5, blue:0.5, alpha: 0.8)
    }
    required init?(coder: NSCoder) {
        fatalError("init(coder:) has not been implemented")
    }
